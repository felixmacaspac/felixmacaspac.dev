...
const projects = [
  {
    ...
    githubLink: "https://www.bluecheck.me/",
    // techno
    html: true,
    css: true,
    javascript: true,
    ...
    <>
      <div className="flex flex-col gap-10">
        {projects.map((proj) => (
          <div
            key={proj.id}
            className="grid grid-cols-1 gap-20 place-content-center items-center xl:grid-cols-2"
          >
            <div>
              ...
              <div className="bg-gray-50 rounded-2xl filter shadow-md relative mt-10 px-10 dark:bg-primary-500">
                <div className="flex flex-row justify-center gap-4 py-10 w-full">
                  {proj.websiteLink && (
                    <a
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 py-6">
                  {proj.html && (
                    <div className="flex flex-col justify-center items-center gap-4 py-4 px-4 bg-gray-50 rounded-xl filter shadow-md dark:bg-primary-400">
                      <img
                        className="h-10 object-contain dark:filter dark:invert"
                        src={images.htmlLogo}
                        alt=""
                      />
                    </div>
            ...
            <div>
              <img
                className="w-full rounded-lg filter shadow-lg"
                loading="lazy"
                width={684}
                height={355}
                src={proj.image}
